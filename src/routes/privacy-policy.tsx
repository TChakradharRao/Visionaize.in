...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Visionaize" },
      {
        name: "description",
        content: "Read the Visionaize Privacy Policy to learn how we collect, use, and protect your personal data.",
      },
    ],
  }),
        ...
        <section className="px-4 py-10 sm:px-6 sm:py-14 md:py-16">
          <div className="mx-auto max-w-6xl text-brand-ink">
            ...
            <ul className="mt-4 list-disc space-y-3 pl-5 text-sm leading-relaxed sm:pl-6 sm:text-base">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Visionaize Technologies Pvt. Ltd. PKT-2/3-D-2, Vasant Kunj, Delhi, India 110070.
              </li>
              <li>
            ...
            <ul className="mt-4 list-disc space-y-3 pl-5 text-sm leading-relaxed sm:pl-6 sm:text-base">
              ...
              <li>
                <strong>Cookies Policy / Notice Acceptance Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies identify if users have accepted the use of cookies on the Website.
              </li>
              <li>
                <strong>Functionality Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.
              </li>
            </ul>
