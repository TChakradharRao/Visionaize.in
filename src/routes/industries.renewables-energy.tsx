...
const KEY_BENEFITS = [
  {
    icon: "https://visionaize.in/wp-content/uploads/2026/05/Mask-group-8.svg",
...
const VALUE_PROPS = [
  ...
  {
    icon: "https://visionaize.in/wp-content/uploads/2026/05/900784-1.svg",
  ...
  {
    icon: "https://visionaize.in/wp-content/uploads/2026/05/2391086-1.svg",
...
const CASE_STUDIES = [
  {
    ...
    image: "https://visionaize.in/wp-content/uploads/2026/05/image-case-stud-y3.jpg",
    tabs: {
      Challenge:
      ...
      Solution:
        "Visionaize deployed an AI-driven site assessment platform that integrates terrain, environmental, and infrastructure data into a single digital twin model, enabling rapid, data-backed comparison of candidate sites.",
      Results:
        "Site selection timelines were significantly reduced, feasibility accuracy improved, and developers gained a repeatable framework for evaluating future renewable projects with greater confidence.",
    },
  },
  {
    title: "AI-Powered Intelligent Demand & Generation Forecasting",
    image: "https://visionaize.in/wp-content/uploads/2026/05/image-1-2.png",
    tabs: {
      Challenge:
      ...
      Solution:
        "Visionaize implemented AI-powered forecasting models that combine historical consumption data, live weather feeds, and generation telemetry to produce continuously updated demand and generation forecasts.",
      Results:
        "The utility achieved markedly improved forecast accuracy, reduced reserve capacity costs, and more efficient grid balancing during periods of high renewable variability.",
    },
  },
  {
    title: "Wind Turbine Predictive Maintenance",
    image: "https://visionaize.in/wp-content/uploads/2026/05/image-3.png",
    tabs: {
      Challenge:
      ...
      Solution:
        "Visionaize deployed predictive maintenance models that continuously monitor turbine sensor data, detecting early signs of component wear and flagging anomalies before they escalate into failures.",
      Results:
        "Unplanned downtime dropped substantially, maintenance was shifted from reactive to condition-based scheduling, and overall turbine availability and energy output improved across the wind farm fleet.",
    },
  },
];
...
function Hero() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://visionaize.in/wp-content/uploads/2026/05/wmremove-transformed-1-1.png')",
    ...
    >
      ...
      <div
        ...
        // style={{
        //   background:
        //     "linear-gradient(180deg, rgba(6,20,36,0.75) 0%, rgba(6,20,36,0.55) 60%, rgba(6,20,36,0.35) 100%)",
        // }}
      />
      <div
        aria-hidden
      ...
      <div className="relative mx-auto flex min-h-[340px] max-w-7xl flex-col justify-center px-4 py-10 xs:min-h-[380px] sm:min-h-[420px] sm:px-6 sm:py-14 md:min-h-[460px] lg:min-h-[520px] lg:px-8 xl:min-h-[560px] xl:px-10 2xl:min-h-[600px]">
        <div className="max-w-xl sm:max-w-2xl md:max-w-3xl">
          <h1 className="text-2xl font-extrabold leading-[1.2] text-white xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[3.5rem]">
            Accelerating Renewable Energy Operations with AI &amp; Digital Twins
          </h1>

          <p className="mt-4 text-sm font-bold leading-snug text-white sm:mt-6 sm:text-lg md:text-xl">
            Smarter Renewable Assets. Higher Efficiency. Predictive Intelligence.
          </p>
          ...
          <Link
            ...
            className="mt-6 inline-flex items-center justify-center whitespace-nowrap rounded-full px-5 py-3 text-xs font-semibold text-white shadow-lg transition-transform hover:scale-[1.02] sm:mt-9 sm:px-8 sm:py-4 sm:text-base"
            style={{
...
function PoweringProgress() {
  return (
    <section className="bg-white py-14 sm:py-16 md:py-20">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-6 px-4 sm:grid-cols-2 sm:gap-8 sm:px-6 md:gap-12 lg:gap-16 lg:px-8">
        {/* Image */}
        <div className="overflow-hidden rounded-lg shadow-lg sm:rounded-2xl">
          <img
            src="https://visionaize.in/wp-content/uploads/2026/05/Gemini_Generated_Image_scs3s1scs3s1scs3-1-1024x576.png"
            alt="Renewable energy site with wind turbines, solar array, and battery storage units"
            className="h-52 w-full object-cover xs:h-60 sm:h-72 md:h-[420px] lg:h-[480px] xl:h-[520px]"
            loading="lazy"
          />
        </div>
        ...
        {/* Copy */}
        <div>
          <h2 className="text-xl font-semibold leading-tight text-brand-navy sm:text-2xl md:text-3xl lg:text-4xl">
  ...
  return (
    <section className="bg-[#0F2237] py-10 sm:py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-5 lg:px-6">
        <h2 className="text-center text-2xl font-semibold text-white sm:text-2xl md:text-4xl">
          Key Benefits
        </h2>

        <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:mt-9 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-9 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-10">
          {KEY_BENEFITS.map((b) => (
  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20">
      <div className="mx-auto grid max-w-6xl items-start gap-10 px-4 sm:px-6 md:grid-cols-2 md:gap-12 lg:px-8">
        {/* Left: copy */}
        <div>
          <h2 className="text-2xl font-semibold leading-tight text-brand-navy sm:text-3xl md:text-4xl">
        ...
        <div>
          <div className="overflow-hidden rounded-xl shadow-lg">
            <img
              src="https://visionaize.in/wp-content/uploads/2026/05/1732179207314-1-1024x576.png"
              alt="AI-powered renewable energy digital twin visualization with wind turbines"
              className="h-56 w-full object-cover sm:h-64 md:h-56 lg:h-64 xl:h-72"
              loading="lazy"
            />
          </div>
          ...
          <div className="mt-5 rounded-xl border border-brand-ink/10 bg-white p-5 shadow-md sm:mt-6 sm:p-6">
            <div className="flex items-center gap-3">
              <img
                src="https://visionaize.in/wp-content/uploads/2026/05/Group-1410138685.svg"
                alt=""
                aria-hidden="true"
  ...
  return (
    <section className="bg-[#0F2237] pb-12 pt-6 sm:pb-16 sm:pt-8 md:pb-20 md:pt-10">
      <div className="mx-auto max-w-[1560px] px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-xl font-semibold text-white sm:text-2xl md:text-3xl lg:text-4xl">
          Visionaize Value Proposition For Renewable Energy
        </h2>

        <div className="mt-6 grid grid-cols-1 gap-3 sm:mt-8 sm:grid-cols-2 sm:gap-4 lg:grid-cols-5 lg:gap-3">
          {VALUE_PROPS.map((v) => (
            <div
              key={v.title}
...
function TalkToExpert() {
  ...
  return (
    <section className="bg-[#0F2237]">
      {/* Top lime banner */}
      <div className="flex flex-col items-center justify-center gap-4 bg-[#A6E04A] px-4 py-6 text-center sm:flex-row sm:gap-6 sm:py-8 md:py-9">
        <p className="text-base font-semibold text-brand-navy sm:text-lg md:text-xl">
          Connect with a Digital Twin specialist
        </p>

        
        <a  href="#talk-to-expert-form"
      ...
      <div className="mx-auto grid max-w-7xl items-start gap-10 px-4 py-12 sm:px-6 sm:py-16 md:grid-cols-2 md:gap-12 lg:px-8 lg:py-20">
        {/* Left copy */}
        <div>
          ...
          <h3 className="mt-8 text-lg font-bold text-white sm:mt-9 sm:text-xl">
        ...
        {/* Right form card */}
        <div id="talk-to-expert-form" className="scroll-mt-24 rounded-xl bg-white p-6 shadow-xl sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-5 space-y-3 sm:mt-6 sm:space-y-4">
            ...
            <button
              ...
              className="w-full rounded-full px-6 py-3 text-sm font-semibold text-white shadow-md transition-transform hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-70"
              style={{
                background: "linear-gradient(90deg, #A6E04A 0%, #5BAE7E 50%, #2E8DC5 100%)",
              }}
            >
...
function WhitepaperCTA() {
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20">
      <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 sm:px-6 md:grid-cols-[minmax(0,400px)_1fr] md:gap-12 lg:px-8">
        <div className="mx-auto w-full max-w-[320px] sm:max-w-[380px] md:max-w-none">
          <img
            src="https://visionaize.in/wp-content/uploads/2026/05/Reinventing-Mockup-1024x1024-1-1.png"
        ...
        <div>
          <h2 className="text-2xl font-semibold leading-snug text-brand-navy sm:text-3xl md:text-4xl">
          ...
          <a  href="/renewable-energy-whitepaper"
            className="mt-6 inline-flex items-center rounded-full border-2 border-brand-navy px-6 py-3 text-sm font-semibold text-brand-navy transition-colors hover:bg-brand-navy hover:text-white sm:mt-7"
          >
            Read the Whitepaper
          </a>
        </div>
