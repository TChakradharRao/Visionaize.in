...
const VR_IMG = "/virtual-reality/iStock-1148243718-1-1024x683.jpg";
const AR_IMG = "/virtual-reality/iStock-1282632037.jpg";
const QUOTE_AVATAR = "/virtual-reality/judha2.jpg";
const WHITEPAPER_IMG = "/virtual-reality/setmore-whitepaper-1-2.png";
...
function GradientPill({ children, href = "#" }: { children: React.ReactNode; href?: string }) {
  return (
    ...
    <a  href={href}
      className="inline-flex items-center justify-center rounded-full px-8 py-3 text-lg font-semibold text-white shadow-md transition hover:opacity-90"
      style={{
        background: "linear-gradient(100deg, #92C122 0%, #088FD1 100%)",
      }}
    >
      {children}
    </a>
  ...
  return (
    <ul className="mt-6 space-y-2 list-disc">
      {items.map((b) => (
        <li
          key={b}
          className={`flex items-start leading-7 text-slate-700 ${className ?? "text-[13px]"}`}
        >
          <span className="mt-2.5 mr-1.5 inline-block h-1.5 w-1.5 rounded-full bg-slate-900" />
          {b}
        </li>
      ))}
    </ul>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-14 pb-20">
        <div className="grid items-center gap-8 sm:grid-cols-1 lg:grid-cols-2">
          <div>
            <h1 className="text-4xl md:text-5xl font-semibold leading-[1.6] text-slate-900">
              Virtual Reality that speeds up learning &amp; planning
            </h1>
            <p className="mt-6 text-[16px] font-semibold text-slate-900">
              <strong>VR for training, onboarding, planning</strong>
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="grid items-center gap-12 sm:grid-cols-1 lg:grid-cols-2">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="mt-6 text-[16px] font-bold text-slate-900">
              <strong>Get more done in less time with AR</strong>
            </p>
      ...
      {/* QUOTE BAND */}
      <section
        className="bg-[#344820] py-20 text-white relative overflow-hidden bg-no-repeat bg-right-bottom martin-image"
        style={{
          backgroundImage:
            "url('/virtual-reality/quotes-ico-min.pngquotes-ico-min.png')",
      ...
      >
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 md:grid-cols-[200px_1fr]">
          ...
          />
          <div>
            <blockquote className="text-2xl md:text-4xl font-semibold leading-snug">
            ...
            <div className="mt-6 text-base font-semibold">Jit Senmazumdar</div>
            <div className="text-sm text-white/80">Advisor</div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div className="flex justify-flex-end" style={{ justifyContent: "flex-end" }}>
            <img
              src={WHITEPAPER_IMG}
