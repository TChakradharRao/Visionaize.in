    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-14 pb-20">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            <h1 className="text-4xl md:text-5xl font-semibold leading-[1.1] text-slate-900">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="order-1 md:order-2">
            ...
            <Bullets items={AR_BULLETS} />
          </div>
        </div>
      </section>

      {/* QUOTE BAND */}
      <section className="bg-[#3F5E1E] py-20 text-white relative overflow-hidden">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 md:grid-cols-[200px_1fr]">
          <img
            src={QUOTE_AVATAR}
            alt="Martin Stook"
            className="h-44 w-44 rounded-full object-cover ring-4 ring-white/10"
          />
          <div>
        ...
        {/* decorative quote arcs */}
        <svg
          className="absolute -right-10 bottom-0 h-72 w-72 opacity-40"
          viewBox="0 0 200 200"
          fill="none"
        >
          <path
            d="M40 180 Q40 80 140 80"
            stroke="url(#g1)"
            strokeWidth="3"
            fill="none"
          />
          <path
            d="M70 180 Q70 110 160 110"
            stroke="url(#g1)"
            strokeWidth="3"
            fill="none"
          />
          <defs>
            <linearGradient id="g1" x1="0" x2="1">
              ...
              <stop offset="1" stopColor="#2BA8C7" />
            </linearGradient>
          </defs>
        </svg>
      </section>
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8">
              <Link
                to="/contact"
                className="inline-flex items-center rounded-full border border-slate-300 bg-white px-7 py-3 text-sm font-semibold text-slate-900 shadow-sm hover:bg-slate-50"
              >
                Explore how
              </Link>
            </div>
